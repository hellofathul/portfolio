                    ...
                    <div
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                <?php endif; ?>
                                <form method="POST" action="<?php echo e(route('password.store')); ?>" class="needs-validation"
                                    novalidate="">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="email" class="form-control" name="email"
                                            value="<?php echo e($request->email); ?>" tabindex="1" required autofocus>
...
<?php /**PATH C:\laragon\www\portfolio\resources\views/auth/reset-password.blade.php ENDPATH**/ ?>