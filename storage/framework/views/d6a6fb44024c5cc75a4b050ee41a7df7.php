            ...
            <div class="col-lg-8">
                <div class="header-text">
                    ...
                    <?php if($hero->btn_text): ?>
                        <a href="<?php echo e($hero->btn_url); ?>" class="button-dark mouse-dir wow fadeInUp"
                            data-wow-delay="0.5s"><?php echo e($hero->btn_text); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\laragon\www\portfolio\resources\views/frontend/sections/hero.blade.php ENDPATH**/ ?>