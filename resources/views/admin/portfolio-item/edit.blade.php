            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.portfolio-item.update', $portfolio_item->id) }}" method="post"
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control selectric" name="category_id">
                                            ...
                                            @foreach ($categories as $category)
                                                <option {{ $category->id == $portfolio_item->category_id ? 'selected' : '' }}
