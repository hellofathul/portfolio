...
<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li
                class="nav-item dropdown {{ setSidebarActive(['admin.footer-social.*', 'admin.footer-info.*', 'admin.footer-contact-info.*', 'admin.footer-useful-link.*']) }}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i>
                    <span>Footer</span></a>
                <ul class="dropdown-menu" style="display: none;">
                    ...
                    <li class="{{ setSidebarActive(['admin.footer-info.*']) }}"><a class="nav-link"
                            href="{{ route('admin.footer-info.index') }}">Information</a></li>
                    <li class="{{ setSidebarActive(['admin.footer-contact-info.*']) }}"><a class="nav-link"
                            href="{{ route('admin.footer-contact-info.index') }}">Contact Info</a></li>
                    <li class="{{ setSidebarActive(['admin.footer-useful-link.*']) }}"><a class="nav-link"
                            href="{{ route('admin.footer-useful-link.index') }}">Useful Links</a></li>
                </ul>
            </li>
